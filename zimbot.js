...
global.reactmoji = "🇿🇼"
global.chatbot = "🌒"
// if (type command here) {
//    ZimBotInc.sendMessage(m.chat, { react: { text: `${global.chatbot}`, key: m.key }})
//    
         ...
         m.reply(`*Antilink disabled*`)
          ...
          let drips = [
             ...
             case 'chatbot': {
                ...
                if (isCreator) throw mess.owner
                if (args[0] === "on") {
                if (db.data.chats[m.chat].chatbot) return reply(`*chatbot already on okay*`)
                db.data.chats[m.chat].chatbot = true
                reply(`*chatbot on enjoy talking to me okay*`)
                } else if (args[0] === "off") {
                if (!db.data.chats[m.chat].chatbot) return reply(`*Already off okay*`)
...
if (isBan) throw mess.ban
		...
		let { quotesAnime } = require('./lib/scraper3')
            ...
            break
            case 'wp': case 'wattpad': case 'wattpreplyearch': {
     ...
     if (isBan) throw mess.ban
            ...
            m.reply(`*1 limit used*`)
                ...
                maker.textpro("https://textpro.me/create-glitch-text-effect-style-tik-tok-983.html", [
                    `${teks1}`,`${teks2}`])
                  .then((data) => ZimBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
...
case 'pencil':
                ...
                if(!q) return reply(`Use ${prefix + command} text`)
                reply(mess.wait)
                maker.textpro("https://textpro.me/sci-fi-text-effect-855.html", [
                    `${q}`,])
                  .then((data) => ZimBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by ${global.botname}` }, { quoted: m }))
                  .catch((err) => console.log(err));
                   break
                ...
                case 'lava': case 'rock': case 'bloodglas': case 'halloween': case 'darkgold': case 'joker': case 'wicker':
                 case 'firework': case 'skeleton': case 'blackpink': case 'sand': case 'glue': case 'robot2': case '1917': case 'leaves': case 'blueglass': case '3dgradient': case 'balloon': case '2022': case 'scifi': {
if (!q) return reply(`Example : ${prefix + command} ${global.ownername}`) 
  if (isBan) return reply(mess.ban)	 			
reply(mess.wait)
let link

if(/robot2/.test(command)) link = 'https://textpro.me/robot-r2-d2-text-effect-903.html'
if (/scifi/.test(command)) link = 'https://textpro.me/create-3d-sci-fi-text-effect-online-1050.html'
if (/2022/.test(command)) link = 'https://textpro.me/new-year-cards-3d-by-name-960.html'
...
if (/blueglass/.test(command)) link ='https://textpro.me/blue-glass-text-effect-908.html' 
if (/balloon/.test(command))  link = 'https://textpro.me/blue-foil-balloon-text-effect-923.html'
if (/3dgradient/.test(command)) link = 'https://textpro.me/3d-gradient-text-effect-online-free-1002.html'

let anu = await maker.textpro(link, q)
  ZimBotInc.sendMessage(m.chat, { image: { url: anu }, caption: `Made by ${global.botname}` }, { quoted: m })
}
break
...
//ZIM BOT INC
	 ...
	 //   //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
		//if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply('Limit Harian Anda Telah Habis')
            ...
            break
            case 'tiktok2': {
if (!text) throw `Use example ${prefix + command} https://www.tiktok.com/@omagreplyus/video/7025456384175017243`
if (!isUrl(args[0]) && !args[0].includes('tiktok.com')) throw '*The link you provided is not valid*'
if (!isInventoryLimit){ addInventoriLimit(m.sender) }
            if (isLimit < 1) return m.reply(mess.endLimit)
            kurangLimit(m.sender, 1)
...
break
       ...
       // //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
		...
		m.reply(mess.wait)
		ZimBotInc.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.xlsx'}, mimetype: 'application/vnd.openxmlformats-officedocument.sprereplyheetml.sheet', fileName: 'juz-amma-arab-latin-indonesia.xlsx'}, {quoted:m})
		} else {
     ...
     case 'setmenu': {
        ...
        let setbot = db.data.settings[botNumber]
           if (args[0] === 'templateImage'){
            ...
            title: "©️𝗭𝗜𝗠 𝗕𝗢𝗧 𝗜𝗡𝗖",
            rows: [
            {title: "𝗧𝗘𝗠𝗣𝗟𝗔𝗧𝗘 𝗜𝗠𝗔𝗚𝗘", rowId: `setmenu templateImage`, description: `Change menu bot to Template Image`},
            {title: "𝗧𝗘𝗠𝗣𝗟𝗔𝗧𝗘 𝗟𝗢𝗖𝗔𝗧𝗜𝗢𝗡", rowId: `setmenu templateLocation`, description: `Change menu bot to Template Location`},
            {title: "T𝗘𝗠𝗣𝗟𝗔𝗧𝗘 𝗚𝗜𝗙", rowId: `setmenu templateGif`, description: `Change menu bot to Template Gif`},
            {title: "𝗧𝗘𝗠𝗣𝗟𝗔𝗧𝗘 𝗠𝗘𝗦𝗦𝗔𝗚𝗘", rowId: `setmenu templateMessage`, description: `Change menu bot to Template Message`},
            {title: "𝗧𝗘𝗠𝗣𝗟𝗔𝗧𝗘 𝗟𝗜𝗦𝗧", rowId: `setmenu templateList`, description: `Change menu bot to Template List`},
            {title: "𝗧𝗘𝗠𝗣𝗟𝗔𝗧𝗘 𝗗𝗢𝗖𝗨𝗠𝗘𝗡𝗧", rowId: `setmenu templateDoc`, description: `Change menu bot to Template Document`}
            ]
            },
            ]
            ZimBotInc.sendListMsg(m.chat, `*Please choose the menu you want to change! I hope you will enjoy🔥*`, ZimBotInc.user.name, `*Hello Owner Cheers to that!*`, `CLICK HERE`, sections, m)
            }
        }
        break
